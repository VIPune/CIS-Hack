...
<body class="cotainer">
    <nav class=" navbar navbar-expand-lg navbar-dark " style="display:flex; background-color: black;">
        <div class="col-1">
            <img src="HorizontalLogo.png " width=" 180 " height=" 70 " class=" d-inline-block align-top " alt=" ">
        </div>
    ...
    <div class=" container-fluid " style="text-align:center;background-color: gold; ">
        ...
        <h1 class="text-muted" style="color: black;"> Course Details</h1>
    </div>
    <div class=" row ">
        <div class=" col-lg-1 "></div>

        <div class=" col-lg-5 col-sc-4 " style=" padding-top: 4%; ">
            <div class=" embed-responsive embed-responsive-16by9 ">
                <iframe class=" embed-responsive-item " src="https://www.youtube.com/embed/2cPXQNbNOsM "></iframe>
                </iframe>
            </div>

        </div>
        <div class=" col-lg-1 col-sc-4 "></div>

        <div class=" col-lg-4 " style=" text-align:justify;padding-top: 1%; ">
            ...
            <ul class=" list-group ">
                ...
                <li class=" list-group-item list-group-item-info ">
                    <h3>Best for beginners and enthusiasts</h3>
                </li>
                <li class=" list-group-item list-group-item-info ">
                    <h3>No Programming Pre-requisite</h3>
                </li>
                <li class=" list-group-item list-group-item-info ">
                    <h3>Simple language & Intuitions</h3>
                </li>
                <li class=" list-group-item list-group-item-info ">
                    <h3>Just @ ₹499/-</h3>
                </li>
            </ul>
            <a href="https://drive.google.com/file/d/1P8_8aMuMKv1EEa2xKu2PAhFunUfEevOq/view?usp=sharing" style=" margin-top:3%; float: right; " type=" button " class=" btn btn-primary btn-lg bt-sc ">View Syllabus</a>
            <a href="https://forms.gle/wdhL29kCfSg4ATws9" style=" margin-top:3%; float: left ; " type=" button " class=" btn btn-primary btn-lg bt-sc ">Enroll Now</a>
        </div>
    </div>
